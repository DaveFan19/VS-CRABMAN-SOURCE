...
idleoffsets = {'-213', '-74'} -- I recommend you have your idle offset at 0
leftoffsets = {'100', '-80'}
downoffsets = {'-27', '-73'}
upoffsets = {'-43', '121'}
rightoffsets = {'-54', '-52'}
...
name_of_character_xml = 'FireMan'
name_of_character = 'fcrab'
name_of_notetype = 'gray'
name_of_notetype2 = '' -- you don't need this, but if you want a notetype that has multiple characters to sing you can use this.
...
local timeshit = 0;
function onUpdate()
 doTweenY('opponentFloatshit', name_of_character, (math.sin(timeshit*5)*40), 0.001, 'linear')
...
function onBeatHit()
	if songName == desecrate and curBeat == 173 then
		invisible = false
	end
